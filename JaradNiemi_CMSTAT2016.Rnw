...
p(\gamma|\ldots) &\propto \prod_{g=1}^G \prod_{n=1}^N N(\varepsilon_{gn}\left|0,\gamma_g\right.\right) IG(\gamma_g|\nu/2,\nu\tau/2) \\
...
\begin{itemize}
\item slides code: \url{https://github.com/jarad/ISU2016}
\item slides pdf: \url{http://www.jarad.me/research/presentations.html}
